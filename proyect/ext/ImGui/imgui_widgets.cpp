...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    ImVec2 size = ImVec2(window->Size.x - 20, 25);
    ...
    window->DrawList->AddRectFilled(bb.Min, bb.Max, ImColor(14, 14, 14, (int)(GetStyle().Alpha * 255.f)), 5);
...
bool ImGui::Tab(const char* Label, const char* Icon, bool Enabled)
{
    ...
    if (Enabled)
    {
        window->DrawList->AddRectFilled(total_bb.Min, total_bb.Max, ImColor(0, 153, 153, (int)(ImGui::GetStyle().Alpha * 255)), 5);
...
bool ImGui::TabHeaderButton(const char* ButtonName, bool enabled, int direction, int TabIndex)
{
    ...
    ImColor BGColor = enabled ? ImColor(0, 153, 153, (int)(GetStyle().Alpha * 255)) : ImColor(16, 16, 16, (int)(GetStyle().Alpha * 255));
    ...
    if (enabled)
        window->DrawList->AddRectFilled(ImVec2(window->Pos.x + Value->second.posx + 1, bb.Min.y + 1), ImVec2(window->Pos.x + Value->second.posx + size.x - 1, bb.Max.y - 1), ImColor(0, 153, 153, (int)(GetStyle().Alpha * 255)), 5, Corner);
...
bool ImGui::ScrollbarEx(const ImRect& bb_frame, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 size_avail_v, ImS64 size_contents_v, ImDrawFlags flags)
{
    ...
    if (axis == ImGuiAxis_Y)
        window->DrawList->AddRectFilledMultiColor(grab_rect.Min, grab_rect.Max, ImColor(0, 153, 153, 0), ImColor(0, 153, 153, 0), ImColor(0, 153, 153, (int)(GetStyle().Alpha * 255)), ImColor(0, 153, 153, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (std::abs(Value->second.a) < 0.9f) //CAIXAS SELEÇAO BOX
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(check_bb.GetWidth() / 2 * Value->second.a + 1, check_bb.GetHeight() / 2 * Value->second.a + 1), check_bb.Max - ImVec2(check_bb.GetWidth() / 2 * Value->second.a + 1, check_bb.GetHeight() / 2 * Value->second.a + 1), ImColor(255, 0, 0, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::CheckboxRisk(const char* label, bool* v)
{
    ...
    if (std::abs(Value->second.a) < 0.9f)
        window->DrawList->AddRectFilled(
            check_bb.Min + ImVec2(check_bb.GetWidth() / 2 * Value->second.a + 1, check_bb.GetHeight() / 2 * Value->second.a + 1),
            check_bb.Max - ImVec2(check_bb.GetWidth() / 2 * Value->second.a + 1, check_bb.GetHeight() / 2 * Value->second.a + 1),
            ImColor(0, 153, 153, (int)(GetStyle().Alpha * 255)), 5);
    ...
    if (std::abs(Value->second.a) < 0.7f)
        RenderCheckMark(window->DrawList,
            check_bb.Min + ImVec2(square_sz / 2, square_sz / 2) - ImVec2(checkmark_size / 2, checkmark_size / 2),
            ImColor(255, 255, 255, (int)(GetStyle().Alpha * 255)),
            checkmark_size);
    ...
    // Desenha o "( Risk )" em vermelho logo após o label
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int itemcount)
{
    ...
    if (!(flags & ImGuiComboFlags_NoPreview))
    {
        ...
        window->DrawList->AddRect(bb.Min, bb.Max, GetColorU32(ImGuiCol_Border), 5);
        window->DrawList->AddCircleFilled(ImVec2(bb.Max.x - 14, bb.Min.y + total_bb.GetHeight() / 2), Value->second.a, ImColor(0, 153, 153, (int)(GetStyle().Alpha * 255)), 360);
    }
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x)//BARRA FOV E DISTANCIA
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(1, 0), ImVec2(frame_bb.Min.x + Value->second.anim + 1, frame_bb.Max.y), ImColor(255, 0, 0, (int)(GetStyle().Alpha * 255)), 5);
